...
const routes: Routes = [
  ...
  {
    path: 'trace', component: TraceComponent, data: { title: 'Trace Report' },
    canActivate: [LoggedInGuardService]
  }
];
...
@NgModule({
  ...
  declarations: [DowntimeComponent, RevpayComponent, NipInbranchComponent, EbillsComponent, TraceComponent],

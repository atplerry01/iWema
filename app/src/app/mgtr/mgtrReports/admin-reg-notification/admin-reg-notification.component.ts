...
@Component({
  selector: 'app-admin-reg-notification',
  templateUrl: './admin-reg-notification.component.html',
  styleUrls: ['./admin-reg-notification.component.scss']
})

export class AdminRegNotificationComponent implements OnInit, OnDestroy {
  ...
  updateRecord(model) {
    ...
    const url = `mgtr/lookups/regulation/updateNotification`;
  ...
  submit() {
    ...
    if (this.updateButton) {
      ...
      const url = `mgtr/lookups/regulation/createNotification`;
    ...
    this.dataService.Get(endPointUrl).subscribe(
      res => {
        if (res && res.data) {
          ...
          res.data.data.map(x => {
            this.policyLists.push({ label: x.Title, value: x.Id });
          });
  ...
  deleteSelected(model) {
    ...
    const url = `mgtr/lookups/regulation/deleteNotification`;
  ...
  getNotifications = () => {
    ...
    const endPointUrl = 'mgtr/lookups/regulation/Notifications?';

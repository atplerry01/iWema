...
import {
  AccountIntroducerComponent, AccstatsComponent,




  AttestationReportComponent, AuditReportComponent, BetPerformanceComponent, CallOverComponent,

  CarsbidsComponent, ChannelMovementComponent,



  ConfidentialComponent, FimiReportComponent, FirstTimeDebitComponent,


  FixedDepositComponent, LimitNotificationComponent, MaturityProfileComponent, PerfmgtComponent, RiskassetComponent,



  RMDashboardComponent, TopDepositorsComponent, WemaCollectComponent
} from './index';
...
@NgModule({
  imports: [RouterModule.forChild([
    ...
    {
      path: 'dqi', component: DQIComponent, data: { title: `DQI Report` },
      canActivate: [LoggedInGuardService]
    }
  ])],

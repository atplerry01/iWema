...
import { getTotalReactivatedAccountsByStaffIdDetail_QUERY } from "./query";
import { executeFinacleDRQuery } from "../../../../db/dbUtil";

export const getTotalReactivatedAccountsByStaffIdDetailCY = async (staffId: string, requestingStaffId: string, 
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalReactivatedAccountsByStaffIdDetailCY${_staffId}`;
        ...
        try {
            const q = getTotalReactivatedAccountsByStaffIdDetail_QUERY( _staffId, 'y'); 

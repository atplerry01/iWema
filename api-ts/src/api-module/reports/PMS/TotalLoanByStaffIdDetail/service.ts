...
import { getTotalLoanByStaffIdDetail_QUERY } from "./query";
import { executeFinacleDRQuery } from "../../../../db/dbUtil";

export const getTotalLoanByStaffIdDetail = async(staffId: string, requestingStaffId: string, 
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalLoanByStaffIdDetail${_staffId}`;
        ...
        const q = getTotalLoanByStaffIdDetail_QUERY('S' + _staffId); // all account

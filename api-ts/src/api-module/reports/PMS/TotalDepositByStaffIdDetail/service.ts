...
import { getTotalDepositByStaffIdDetail_QUERY } from "./query";
import { executeFinacleDRQuery } from "../../../../db/dbUtil";


export const getTotalDepositByStaffIdDetail = (staffId: string, requestingStaffId: string,
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalDepositByStaffIdDetail${_staffId}`;
        ...
        const q = getTotalDepositByStaffIdDetail_QUERY('S' + _staffId);

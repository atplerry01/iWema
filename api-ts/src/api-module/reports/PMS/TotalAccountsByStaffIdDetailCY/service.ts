...
import { getTotalAccountsByStaffIdDetail_QUERY } from "../TotalAccountsByStaffIdDetail/query";


export const getTotalAccountsByStaffIdDetailCY = async (staffId: string, requestingStaffId: string, 
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalAccountsByStaffIdDetailCY${_staffId}`;
        ...
        try {
         ...
         const q = getTotalAccountsByStaffIdDetail_QUERY('S' + _staffId, 'y');  // all account opened this year

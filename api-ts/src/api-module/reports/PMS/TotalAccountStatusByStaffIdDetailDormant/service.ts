...
export const getTotalAccountStatusByStaffIdDetailDormant = async(staffId: string, requestingStaffId: string, 
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalAccountStatusByStaffIdDetailDormant${_staffId}`;
        ...
        try {
            const q = getTotalAccountStatusByStaffIdDetail_QUERY('S' + _staffId, 'D'); 

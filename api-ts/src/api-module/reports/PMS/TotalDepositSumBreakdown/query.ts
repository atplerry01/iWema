...
// oracle  // staffId = 'S08166' => relationship manager //Total Deposit Breakdown  
export const getTotalDepositSumBreakdown_QUERY = (staffId: string, period: string) => {
    const dt = new Date();
    ...
    acct_opn_date DATE_OPENED,  (clr_bal_amt * CUSTOM.AmountToFC('NOR','${dateTo}', 
    gam.acct_crncy_code,'NGN')) ACTUAL_BAL,  (custom.getAvgBal_cr(gam.acid,'${dateFrom}','${dateTo}') * CUSTOM.AmountToFC('NOR','${dateTo}',gam.acct_crncy_code,'NGN')) AVERAGE_BAL

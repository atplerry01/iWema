...
import { getTotalDepositSumBreakdown_QUERY } from "./query";
import { executeFinacleDRQuery } from "../../../../db/dbUtil";


export const getTotalDepositSumBreakdown = (staffId: string, requestingStaffId: string, 
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalDepositSumBreakdown${_staffId}`;
        ...
        try {
             const q = getTotalDepositSumBreakdown_QUERY( _staffId, 'm'); 

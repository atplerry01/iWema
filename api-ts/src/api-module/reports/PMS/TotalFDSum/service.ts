...
import { getTotalFDSum_QUERY } from "./query";
import { executeFinacleDRQuery } from "../../../../db/dbUtil";

export const getTotalFDSum = async(staffId: string, requestingStaffId: string, 
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalFDSum${_staffId}`;
        ...
        try {
             const q = getTotalFDSum_QUERY( _staffId, 'm'); 

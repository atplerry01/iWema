...
import { getTotalReactivatedAccountsByStaffIdDetail_QUERY } from "../TotalReactivatedAccountsByStaffIdDetailCY/query";

export const getTotalReactivatedAccountsByStaffIdDetailCM = (staffId: string, requestingStaffId: string, 
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalReactivatedAccountsByStaffIdDetailCM${_staffId}`;
        ...
        try {
             const q = getTotalReactivatedAccountsByStaffIdDetail_QUERY( _staffId, 'm'); 

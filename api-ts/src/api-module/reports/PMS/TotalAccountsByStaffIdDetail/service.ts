...
import { getTotalAccountsByStaffIdDetail_QUERY } from "./query";

export const getTotalAccountsByStaffIdDetail = async (staffId: string, requestingStaffId: string, 
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalAccountsByStaffIdDetail${_staffId}`;
        ...
        const q = getTotalAccountsByStaffIdDetail_QUERY('S' + _staffId, '');  // staffId = '08166'

...
export const getTotalAccountStatusByStaffIdDetailInactive = (staffId: string, requestingStaffId: string, 
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const key = `getTotalAccountStatusByStaffIdDetailInactive${_staffId}`;
        ...
        try {
           ...
           const q = getTotalAccountStatusByStaffIdDetail_QUERY('S' + _staffId, 'I'); 

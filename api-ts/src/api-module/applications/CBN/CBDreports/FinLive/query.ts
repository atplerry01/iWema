...
// MandateByProduct
//startDate: any
export const getFinLiveQuery = (startDate) => {
  // tslint:disable-next-line: max-line-length
  return `  
  select a.cif_id "Customer Id", 
a.foracid "Account Number",a.acct_name,
a.Acct_Cls_Flg  "Account Closed" ,
...
(select schm_desc from custom.crcloans where trim(schm_desc) = trim(c.Fac_Type) and Rownum = 1) "Loan Type",

...
import { getGuarantorInformationService } from "./service";

export const getGuarantorInformationRoutes = (req, res, jwt) => {
  isAuthenticated(req, jwt)
    .then(async (_decoded_token: any) => {
      ...
      try {
        const entity = await getGuarantorInformationService(startDate);

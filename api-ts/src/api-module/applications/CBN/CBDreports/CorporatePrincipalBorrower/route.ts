...
import { getCorporatePrincipalService } from "./service";

export const getCorporatePrincipalRoutes = (req, res, jwt) => {
  isAuthenticated(req, jwt)
    .then(async (_decoded_token: any) => {
      ...
      try {
        const entity = await getCorporatePrincipalService(startDate);

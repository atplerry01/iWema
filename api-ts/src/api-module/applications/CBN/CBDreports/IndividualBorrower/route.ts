...
import { getIndividualBorrowerService } from "./service";

export const getIndividualBorrowerRoutes = (req, res, jwt) => {
  isAuthenticated(req, jwt)
    .then(async (_decoded_token: any) => {
      ...
      try {
        const entity = await getIndividualBorrowerService(startDate);

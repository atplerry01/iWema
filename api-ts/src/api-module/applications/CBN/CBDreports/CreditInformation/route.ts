...
import { getCreditInformationService } from "./service";

export const getCreditInformationRoutes = (req, res, jwt) => {
  isAuthenticated(req, jwt)
    .then(async (_decoded_token: any) => {
      ...
      try {
        const entity = await getCreditInformationService(startDate);

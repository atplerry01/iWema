...
import { getAccountsOpenedService } from "./service";

export const getAccountsOpenedRoutes = (req, res, jwt) => {
  isAuthenticated(req, jwt)
    .then(async (_decoded_token: any) => {
      ...
      try {
        const entity = await getAccountsOpenedService(startDate, endDate);

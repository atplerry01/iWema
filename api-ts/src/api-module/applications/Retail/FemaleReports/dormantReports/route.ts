...
import { getDormantAccountService } from "./service";

export const getDormantAccountRoutes = (req, res, jwt) => {
  isAuthenticated(req, jwt)
    .then(async (_decoded_token: any) => {
      ...
      try {
        const entity = await getDormantAccountService(startDate, endDate);

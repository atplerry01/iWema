...
import { getAccReactivationService } from './service';

export const getAccReactivationRoute = (req, res, jwt) => {
  isAuthenticated(req, jwt)
    .then(async (_decoded_token: any) => {
      ...
      // const key = `${'getAccReactivationRoute'}&${startDate}&${endDate}&${page}&${per_page}`;
      ...
      try {
        ...
        const entity = await getAccReactivationService(branchCode, startDate, endDate);
